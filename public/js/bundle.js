...
var login = function login(email, password) {
  ...
  (0, _axios.default)({
    ...
    data: {
      email: email,
      // js is smart enough to understand this as 
    ...
    if (response.data.status == 'success') {
      ...
      localStorage.setItem('chk-data', response.data.user.salt); // user cart
    ...
    // if res status is other than 200 then it is treated as error
...
var signup = function signup(firstname, lastname, email, password) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    },
...
var getforgotpassword = function getforgotpassword() {
...
var getsignup = function getsignup() {
...
var LoginListener = function LoginListener(e) {
  ...
  (0, _authHelper.login)(email, password);
};

var LogoutListener = function LogoutListener(e) {
  e.preventDefault();
  (0, _authHelper.logout)();
};

var SignupListener = function SignupListener(e) {
  e.preventDefault();
  var firstname = document.getElementById('firstname').value;
  var lastname = document.getElementById('lastname').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('signuppassword').value;
  (0, _authHelper.signup)(firstname, lastname, email, password);
};

var ForgotPasswordListener = function ForgotPasswordListener(e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  (0, _authHelper.forgotpassword)(email);
};

var ResetPasswordListener = function ResetPasswordListener(e) {
  e.preventDefault();
...
var GetForgotPasswordListener = function GetForgotPasswordListener(e) {
  e.preventDefault();
  (0, _authHelper.getforgotpassword)();
};

var GetLoginListener = function GetLoginListener(e) {
  e.preventDefault();
  (0, _authHelper.getlogin)();
};

var GetSignupListener = function GetSignupListener(e) {
  e.preventDefault();
  (0, _authHelper.getsignup)();
};
...
var getAdminPanel = function getAdminPanel(userid, token) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    ...
    method: 'get',
    url: "/gvj-api/checkAdmin/".concat(userid)
  }).then(function (response) {
...
},{"axios":"../../node_modules/axios/index.js"}],"admin/getAdminPanelListener.js":[function(require,module,exports) {
"use strict";

var _getAdminPanel = require("./getAdminPanel");

var userid = localStorage.getItem('userid');
var token = localStorage.getItem('token'); // no security for admin sections -- note because m only the admin

var getAdminPanelListener = function getAdminPanelListener(e) {
  e.preventDefault();
  (0, _getAdminPanel.getAdminPanel)(userid, token);
};

module.exports = {
  getAdminPanelListener: getAdminPanelListener
};
},{"./getAdminPanel":"admin/getAdminPanel.js"}],"admin/categories/categoryHelper.js":[function(require,module,exports) {
"use strict";
...
var getAllCategories = function getAllCategories(token, userid) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
    ...
    if (response.data.status == 'success') {
      location.assign("/gvj-api/categories/".concat(userid)); // get me just all the categories
    }
  }).catch(function (error) {
    if (error.response.data.error) {
      console.log(error.response.data.error);
...
var getCategoryUpdate = function getCategoryUpdate(id, token, userid) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
    ...
    if (response.data.status == 'success') {
      location.assign("/gvj-api/category/".concat(id));
    }
  }).catch(function (error) {
    if (error.response.data.error) {
      console.log(error.response.data.error);
...
var doCategoryUpdate = function doCategoryUpdate(id, token, userid, name) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
    ...
    method: 'put',
    url: "/gvj-api/category/".concat(id, "/").concat(userid),
    data: {
      name: name
    }
  }).then(function (response) {
    ...
    window.setTimeout(function () {
      location.assign("/gvj-api/categories/".concat(userid));
    }, 2000);
  }).catch(function (error) {
    if (error.response.data.error) {
      console.log(error.response.data.error);
...
var createCategory = function createCategory(userid, name, token) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
    ...
    method: 'post',
    url: "/gvj-api/category/create/".concat(userid),
    data: {
      name: name
    }
  }).then(function (response) {
...
var deleteCategory = function deleteCategory(id, token, userid) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
},{"axios":"../../node_modules/axios/index.js"}],"admin/categories/categoryListener.js":[function(require,module,exports) {
"use strict";

var _categoryHelper = require("./categoryHelper");

var token = localStorage.getItem('token');
var userid = localStorage.getItem('userid');

var getAllCategoriesListener = function getAllCategoriesListener(e) {
  e.preventDefault();
  (0, _categoryHelper.getAllCategories)(token, userid);
};

var getCategoryUpdateListener = function getCategoryUpdateListener(e) {
  e.preventDefault(); //console.log(e.target.name)

  (0, _categoryHelper.getCategoryUpdate)(e.target.name, token, userid); // need details of the product
  // so will call get Category by id here
};

var doCategoryUpdateListener = function doCategoryUpdateListener(e) {
  e.preventDefault();
  var id = document.getElementById('docategoryupdate').name;
  var name = document.getElementById('categoryname').value;
  (0, _categoryHelper.doCategoryUpdate)(id, token, userid, name);
};

var createCategoryListener = function createCategoryListener(e) {
  e.preventDefault();
  var name = document.getElementById('createcategoryname').value;
  (0, _categoryHelper.createCategory)(userid, name, token);
};

var deleteCategoryListener = function deleteCategoryListener(e) {
  e.preventDefault();
  (0, _categoryHelper.deleteCategory)(e.target.name, token, userid);
};
...
},{"./categoryHelper":"admin/categories/categoryHelper.js"}],"../../node_modules/form-data/lib/browser.js":[function(require,module,exports) {
...
},{}],"admin/products/productHelper.js":[function(require,module,exports) {
"use strict";
...
var getAllProducts = function getAllProducts(userid, token) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
    ...
    if (response.data.status == 'success') {
      location.assign("/gvj-api/allproducts/".concat(userid)); // get me just all the categories
    }
  }).catch(function (error) {
    if (error.response.data.error) {
      console.log(error.response.data.error);
...
var getCreateProduct = function getCreateProduct(userid, token) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
...
var doCreateProduct = function doCreateProduct(userid, token, name, description, stock, sold, price, discount, category) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
    ...
    method: 'post',
    url: "/gvj-api/product/create/".concat(userid),
    data: {
      name: name,
    ...
    console.log(response.data.message);
    window.setTimeout(function () {
      location.assign("/gvj-api/allproducts/".concat(userid));
    }, 2000);
  }).catch(function (error) {
    console.log(error.response);
...
var uploadProductPhoto = function uploadProductPhoto(userid, token, id, photo) {
  ...
  (0, _axios.default)({
    ...
    method: 'post',
    url: "/gvj-api/product/".concat(userid, "/upload/").concat(id),
    data: form
  }).then(function (response) {
    console.log(response.data.message);
    window.setTimeout(function () {
...
var deleteProduct = function deleteProduct(userid, token, id) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
    ...
    method: 'delete',
    url: "/gvj-api/product/".concat(id, "/").concat(userid)
  }).then(function (response) {
    console.log(response.data.message);
    window.setTimeout(function () {
      location.assign("/gvj-api/allproducts/".concat(userid));
...
var getProductUpdate = function getProductUpdate(userid, token, id) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
    ...
    if (response.data.status == 'success') {
      location.assign("/gvj-api/getupdateproduct/".concat(id)); // get me just all the categories
    }
  }).catch(function (error) {
    if (error.response.data.error) {
      console.log(error.response.data.error);
...
var doProductUpdate = function doProductUpdate(userid, token, id, name, description, stock, sold, price, discount) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
},{"axios":"../../node_modules/axios/index.js","form-data":"../../node_modules/form-data/lib/browser.js"}],"admin/products/productListener.js":[function(require,module,exports) {
"use strict";

var _productHelper = require("./productHelper");

var userid = localStorage.getItem('userid');
var token = localStorage.getItem('token');

var getAllProductsListener = function getAllProductsListener(e) {
  e.preventDefault();
  (0, _productHelper.getAllProducts)(userid, token);
};

var getCreateProductListener = function getCreateProductListener(e) {
  e.preventDefault();
  (0, _productHelper.getCreateProduct)(userid, token);
};

var doCreateProductListener = function doCreateProductListener(e) {
  e.preventDefault();
  var name = document.getElementById('createproductname').value;
  var description = document.getElementById('createproductdescription').value;
  var stock = document.getElementById('createproductstock').value;
  var sold = document.getElementById('createproductsold').value;
  var price = document.getElementById('createproductprice').value;
  var discount = document.getElementById('createproductdiscount').value;
  var category = document.getElementById('categoryname').value;
  (0, _productHelper.doCreateProduct)(userid, token, name, description, stock, sold, price, discount, category);
};

var uploadProductPhotoListener = function uploadProductPhotoListener(e) {
  var id = e.target.name; // getting the clicked element

  var photo = document.getElementById(id).files[0]; // only _id given as id to photos--

  (0, _productHelper.uploadProductPhoto)(userid, token, id, photo);
};

var deleteProductListener = function deleteProductListener(e) {
  var id = e.target.name;
  (0, _productHelper.deleteProduct)(userid, token, id);
};

var getProductUpdateListener = function getProductUpdateListener(e) {
  e.preventDefault();
  var id = e.target.name;
  (0, _productHelper.getProductUpdate)(userid, token, id);
};

var doProductUpdateListener = function doProductUpdateListener(e) {
  e.preventDefault();
  var id = e.target.name;
  ...
  var stock = document.getElementById('updateproductstock').value;
  var sold = document.getElementById('updateproductsold').value;
  var price = document.getElementById('updateproductprice').value;
  var discount = document.getElementById('updateproductdiscount').value;
  (0, _productHelper.doProductUpdate)(userid, token, id, name, description, stock, sold, price, discount);
};
...
},{"./productHelper":"admin/products/productHelper.js"}],"admin/AdminOrders/adminOrderHelper.js":[function(require,module,exports) {
"use strict";
...
var getAllOrders = function getAllOrders(userid, token) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
...
var changeStatus = function changeStatus(userid, token, orderid, status) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
    method: 'put',
    url: "/gvj-api/order/changestatus/".concat(userid, "/").concat(orderid),
    data: {
      status: status
    }
  }).then(function (response) {
...
},{"axios":"../../node_modules/axios/index.js"}],"admin/AdminOrders/adminOrderListener.js":[function(require,module,exports) {
"use strict";

var _adminOrderHelper = require("./adminOrderHelper");

var userid = localStorage.getItem('userid');
var token = localStorage.getItem('token');

var getAllOrdersListener = function getAllOrdersListener(e) {
  e.preventDefault();
  (0, _adminOrderHelper.getAllOrders)(userid, token);
};

var changeStatusListener = function changeStatusListener(e) {
  e.preventDefault();
  var orderid = e.target.name;
  var status = document.getElementById(orderid).value;
  (0, _adminOrderHelper.changeStatus)(userid, token, orderid, status);
};
...
},{"./adminOrderHelper":"admin/AdminOrders/adminOrderHelper.js"}],"user/Settings/SettingsHelper.js":[function(require,module,exports) {
"use strict";
...
var changePassword = function changePassword(userid, token, usercurrentpassword, usernewpassword) {
  (0, _axios.default)({
    headers: {
      Authorization: "Bearer ".concat(token)
    },
    method: 'put',
    url: "/gvj-api/user/changepassword/".concat(userid),
    data: {
...
var uploadUserPhoto = function uploadUserPhoto(userid, token, usersalt, photo) {
...
var getAccountPageListener = function getAccountPageListener(e) {
  e.preventDefault();
  (0, _SettingsHelper.getAccountPage)(userid, token, usersalt);
};

var changePasswordListener = function changePasswordListener(e) {
  e.preventDefault();
...
var uploadUserPhotoListener = function uploadUserPhotoListener(e) {
  var id = e.target.name; // getting the clicked element
...
var addItemToCart = function addItemToCart(userid, token, id) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
    ...
    method: 'post',
    url: "/gvj-api/cart/addtocart/".concat(userid),
    data: {
      id: id
    }
  }).then(function (response) {
...
var getCartPage = function getCartPage(userid, token, usersalt) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
var removeFromCart = function removeFromCart(userid, token, usersalt, cartid) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
var applyQuantity = function applyQuantity(userid, token, usersalt, cartid, quantity) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
var getCartPageListener = function getCartPageListener(e) {
  e.preventDefault();
  (0, _CartHelper.getCartPage)(userid, token, usersalt);
};
...
var getMyOrder = function getMyOrder(userid, token, usersalt) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
var getMyPurchases = function getMyPurchases(userid, token, usersalt) {
  (0, _axios.default)({
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
      Authorization: "Bearer ".concat(token)
...
var getMyOrdersListener = function getMyOrdersListener(e) {
  e.preventDefault();
  (0, _OrderHelper.getMyOrder)(userid, token, usersalt);
};

var getMyPurchasesListener = function getMyPurchasesListener(e) {
  e.preventDefault();
  (0, _OrderHelper.getMyPurchases)(userid, token, usersalt);
};
...
},{"./OrderHelper":"user/Orders/OrderHelper.js"}],"Payment/stripe.js":[function(require,module,exports) {
"use strict";
...
var doCheckout = function doCheckout(userid, token) {
...
var doCheckoutListener = function doCheckoutListener(e) {
  e.preventDefault();
  (0, _stripe.doCheckout)(userid, token);
};

module.exports = {
  doCheckoutListener: doCheckoutListener
};
},{"./stripe":"Payment/stripe.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _authListeners = require("./auth/authListeners");

var _getAdminPanelListener = require("./admin/getAdminPanelListener");

var _categoryListener = require("./admin/categories/categoryListener");

var _productListener = require("./admin/products/productListener");

var _adminOrderListener = require("./admin/AdminOrders/adminOrderListener");

var _SettingsListener = require("./user/Settings/SettingsListener");

var _CartListener = require("./user/Cart/CartListener");

var _OrderListener = require("./user/Orders/OrderListener");

var _paymentlistener = require("./Payment/paymentlistener");
...
var getsignup = document.getElementById('getsignup'); //AUTH__SECTION-----ENDS
// ADMIN_SECTION
//categories
...
var createcategory = document.getElementById('createcategory'); //categories__ends
//products
...
var doproductupdate = document.getElementById('doproductupdate'); //product_ends
// Getting Admin Panel 

var getpanel = document.getElementById('getpanel'); // Ending Admin Panel
// Admin Order__sec

var getallorders = document.getElementById('getallorders');
var changestatus = document.querySelectorAll('#changestatus'); // Admin Order_sec Ends
//ADMIN__SECTION ENDS
// USER_SECTION
// Settings
...
var getmypurchases = document.getElementById('getmypurchases'); // var filterorders = document.getElementById('filterorders')
// if(filterorders){
...
var checkout = document.getElementById('checkout'); // Payment Ends
//-1

if (signup) {
  signup.addEventListener('click', _authListeners.SignupListener);
}

if (login) {
  login.addEventListener('click', _authListeners.LoginListener);
}

if (logout) {
  logout.addEventListener('click', _authListeners.LogoutListener);
}

if (forgotpassword) {
  forgotpassword.addEventListener('click', _authListeners.ForgotPasswordListener);
}

if (resetpassword) {
  resetpassword.addEventListener('click', _authListeners.ResetPasswordListener);
}

if (getforgotpassword) {
  getforgotpassword.addEventListener('click', _authListeners.GetForgotPasswordListener);
}

if (getlogin) {
  getlogin.addEventListener('click', _authListeners.GetLoginListener);
}

if (getsignup) {
  getsignup.addEventListener('click', _authListeners.GetSignupListener);
} // -11
//-2


if (getallcategories) {
  getallcategories.addEventListener('click', _categoryListener.getAllCategoriesListener);
}

if (getcategoryupdate) {
  // so imp because there would be many update buttons i.e now
  // choosing the one which we clicked
  getcategoryupdate.forEach(function (cat) {
    cat.addEventListener('click', _categoryListener.getCategoryUpdateListener);
  });
}

if (docategoryupdate) {
  docategoryupdate.addEventListener('click', _categoryListener.doCategoryUpdateListener);
}

if (createcategory) {
  createcategory.addEventListener('click', _categoryListener.createCategoryListener);
}

if (deletecategory) {
  deletecategory.forEach(function (cat) {
    cat.addEventListener('click', _categoryListener.deleteCategoryListener);
  });
} // -22
// -3
...
if (getallproducts) {
  getallproducts.addEventListener('click', _productListener.getAllProductsListener);
}

if (getcreateproduct) {
  getcreateproduct.addEventListener('click', _productListener.getCreateProductListener);
}

if (docreateproduct) {
  docreateproduct.addEventListener('click', _productListener.doCreateProductListener);
}

if (uploadproductphoto) {
  uploadproductphoto.forEach(function (upload) {
    upload.addEventListener('click', _productListener.uploadProductPhotoListener);
  });
}

if (deleteproduct) {
  deleteproduct.forEach(function (delprod) {
    delprod.addEventListener('click', _productListener.deleteProductListener);
  });
}

if (getproductupdate) {
  getproductupdate.forEach(function (prod) {
    prod.addEventListener('click', _productListener.getProductUpdateListener);
  });
}

if (doproductupdate) {
  doproductupdate.addEventListener('click', _productListener.doProductUpdateListener);
} // TODO CHANGE ORDER STATUS
// Orders here


if (getallorders) {
  getallorders.addEventListener('click', _adminOrderListener.getAllOrdersListener);
}

if (changestatus) {
  changestatus.forEach(function (status) {
    status.addEventListener('click', _adminOrderListener.changeStatusListener);
  });
} // Getting Admin PAnel with security


if (getpanel) {
  getpanel.addEventListener('click', _getAdminPanelListener.getAdminPanelListener);
} // -33
// 4


if (usersettings) {
  usersettings.addEventListener('click', _SettingsListener.getAccountPageListener);
}

if (changepassword) {
  changepassword.addEventListener('click', _SettingsListener.changePasswordListener);
}

if (uploaduserphoto) {
  uploaduserphoto.addEventListener('click', _SettingsListener.uploadUserPhotoListener);
} // -44
// 5
...
if (additemtocart) {
  additemtocart.forEach(function (item) {
    item.addEventListener('click', _CartListener.addItemToCartListener);
  });
}

if (getmycart) {
  getmycart.addEventListener('click', _CartListener.getCartPageListener);
}

if (removefromcart) {
  removefromcart.forEach(function (item) {
    item.addEventListener('click', _CartListener.removeFromCartListener);
  });
}

if (applyquantity) {
  applyquantity.forEach(function (quantity) {
    quantity.addEventListener('click', _CartListener.applyQuantityListener);
  });
} //--55
// -6
